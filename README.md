...
1. **Authentication & Authorization**: Secure signup/login using JSON Web Tokens (JWT) and bcryptjs password hashing.
2. **Dashboard Overview**: Metrics overview tracking total tasks, tasks in progress, completed progress percentages, and overdue tasks. Shows user-assigned tasks and active project scopes.
3. **Project Management**: Partition tasks by projects. Admins can create and delete projects; Members can view all projects in the workspace.
4. **Kanban Task Board**: Grid layout displaying tasks by status: "To Do", "In Progress", and "Done". Support for due date warning, assignee updating, and task deletion.
5. **Database Seeding**: Built-in 1-click database seeding endpoint to create sample users, projects, and tasks for quick evaluation.
